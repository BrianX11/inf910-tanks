...
public class GameManager : MonoBehaviour
{
    ...
    private IEnumerator RoundEnding()
    {
        ...
        if (m_RoundWinner != null)
        {
            ...
            if(m_RoundWinner.m_Wins == m_NumRoundsToWin)
                m_EndWait = new WaitForSeconds(Mathf.Infinity);
        }
    ...
    private string EndMessage()
    {
        ...
        if (m_GameWinner != null)
            message = "¡" + m_GameWinner.m_ColoredPlayerText + " GANA EL JUEGO CON " 
                + "<color=#" + ColorUtility.ToHtmlStringRGB(m_GameWinner.m_PlayerColor) + "> " + m_GameWinner.m_Wins + "</color>" 
        + " RONDAS GANADAS!";
